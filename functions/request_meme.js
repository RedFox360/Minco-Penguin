...
exports["default"] = (function (message, args, client, profileData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.users.fetch("769313131108237322")];
            case 1:
                mason = _a.sent();
                meme = "";
                ...
                if (!args[1])
                    return [2 /*return*/, message.channel.send("Valid  export const usage =  !buy meme <meme>")];
                ...
                returnEmbed = new Discord.MessageEmbed()
                    ...
                    .setAuthor("Mason L")
                    .setTitle("Meme Request")
                    .setDescription("You have succesfully sent Mason L a meme request:\n__" + meme + "__\n**Reactions**\n\uD83D\uDCDE: Send a message to Mason\n\u26D4\uFE0F: cancel your request");
                return [4 /*yield*/, mason.send(requestEmbed)];
            case 2:
                reactMsgMa = _a.sent();
            ...
            case 4:
                ...
                return [4 /*yield*/, reactMsgMa.react("✅")];
            case 5:
                _a.sent();
                return [4 /*yield*/, reactMsgMa.react("🚫")];
            case 6:
            ...
            case 12:
                ...
                collector = reactMsgMa.createReactionCollector(filter, {
                    time: ms("30m")
                });
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                mason.send("Accept the request first before choosing a price.").then(function (msg) {
                                    setTimeout(function () {
                                        msg["delete"]();
                                    }, 5000);
                                });
                            ...
                            case 5:
                                ...
                                mason.send("Enter a valid number");
                                return [3 /*break*/, 8];
                            case 6:
                                if (price_1 > profileData.mincoDollars) {
                                    message.author.send("Mason L has decided on a price of " + price_1 + " dollars. However, you don't have that much money. (you can send Mason L a message by using the :telephone_receiver: button)");
                                    mason.send(message.author.toString() + " doesn't have that much money. You can decide on a different price or decline the meme request.");
                                }
                                return [4 /*yield*/, message.author.send("Mason L has decided on a price of " + price_1 + " Minco Dollars.\nReact below with a :white_check_mark: to agree and give " + price_1 + " Minco Dollars to claire.\nReact with a :no_entry_sign: if you disagree with the price.")];
                            case 7:
                                ...
                                confirmCollector_1.on("collect", function (reaction, user) { return __awaiter(void 0, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 2:
                                                _a.sent();
                                                mason.send(message.author.toString() + " has confirmed the price. You have received " + price_1 + " Minco Dollars");
                                                message.author.send("You have accepted the price. " + price_1 + " Minco Dollars from your profile have been given to Mason L.");
                                                return [3 /*break*/, 4];
                                            case 3:
                                                mason.send(message.author.toString() + " disagreed with the price. You can decline the request or choose a new price.");
                                ...
                                mason.send("Price set to " + price_1 + " Minco Dollars").then(function (msg) {
                                    setTimeout(function () {
                                        msg["delete"]();
                                    }, 10000);
                                });
                            ...
                            case 12:
                                _b.sent();
                                botMsg["delete"]();
                                mason.send("Message sent").then(function (msg) {
                                    setTimeout(function () {
                                        msg["delete"]();
                                    }, 2000);
                                });
                                _b.label = 13;
                            case 13:
                                userReactions = reactMsgMa.reactions.cache.filter(function (react) { return react.users.cache.has("769313131108237322"); });
                                _b.label = 14;
                            case 14:
                            ...
                            case 15:
                                ...
                                reaction_1 = _a[_i];
                                return [4 /*yield*/, reaction_1.users.remove("769313131108237322")];
                            case 16:
                                _b.sent();
                                _b.label = 17;
                            case 17:
                ...
                authorCollector.on("collect", function (reaction, user) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                userMessage = _b.sent();
                                return [4 /*yield*/, mason.send("Message from " + message.author.toString() + ": " + userMessage.content)];
                            case 3:
                                _b.sent();
                                botMsg["delete"]();
