		...
		builder
			...
			.addSubcommand(subcommand =>
				subcommand
					.setName('collatz')
					.setDescription(
						'Checks the collatz conjecture on a number'
					)
					.addIntegerOption(
			...
			switch (subcommand) {
				...
				case 'collatz': {
					...
					if (sequence.length < 1000)
						...
						const sequenceChunks = chunkString(
							sequence,
							1_000
						);
