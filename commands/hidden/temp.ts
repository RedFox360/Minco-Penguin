...
export const description = "Temp command for Sameer";
		...
		if (args[0] == "2") {
			message.channel.send(
				new MessageEmbed()
					...
					.setDescription(
						"<@339254240012664832> allows users to earn levels by typing messages. When you reach different levels, your name will change color."
					)
					.setColor("ORANGE")
			);
		}
