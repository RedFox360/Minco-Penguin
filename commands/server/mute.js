...
module.exports = {
    ...
    async execute(message, args, cmd) {
        ...
        if ((message.member.hasPermission("MANAGE_MESSAGES") && message.member.roles.cache.find(r => r.name === "Moderator") || message.member.hasPermission("MANAGE_ROLES")) || message.author.id == '802668636795830292') {
            ...
            if (memberTarget.hasPermission('ADMINISTRATOR') || memberTarget.hasPermission('MANAGE_CHANNELS') || memberTarget.roles.cache.find(r => r.name === "Moderator") || memberTarget.id == '724786310711214118') return `<@${memberTarget.id}> cannot be muted`;
