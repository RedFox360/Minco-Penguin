            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (amount > profileData.mincoDollars)
                        return [2 /*return*/, message.channel.send("You don't have " + amount + " Minco Dollars.")];
                    if (amount <= 0)
                        return [2 /*return*/, message.channel.send("You have to bet a positive number of Minco Dollars")];
                    if (amount > 20)
