...
module.exports = {
	...
	async execute(message, args, _0, _1, profileData) {
		...
		if (amount > profileData.mincoDollars) return message.channel.send(`You don't have ${amount} Minco Dollars in your wallet.`);
		if (amount <= 0) return message.channel.send("You have to bet a positive whole number of Minco Dollars");
