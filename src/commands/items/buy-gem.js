...
module.exports = {
	...
	run(message, args, _0, _1, profileData) {
		if (args[0] == "01") {
			buyGem(
				message,
				"Blue Diamond <:blue_diamond:843178044894216202>",
				100,
				"01",
				profileData
			);
			...
			buyGem(
				message,
				"Pink Diamond <:pink_diamond:843177780946010132>",
				150,
				"02",
				profileData
			);
			...
			buyGem(
				message,
				"Emerald <:emerald:843180288984219689>",
				150,
				"03",
				profileData
			);
			...
			buyGem(
				message,
				"Gold Bar <:gold_bar:843180638705287188>",
				75,
				"04",
				profileData
			);
			...
			buyGem(
				message,
				"Sapphire <:sapphire:843182746050232340>",
				75,
				"05",
				profileData
			);
			...
			buyGem(
				message,
				"Amethyst <:amethyst:843184890337296454>",
				50,
				"07",
				profileData
			);
			...
			buyGem(
				message,
				"Black Diamond <:black_diamond:843607902136696862>",
				500,
				"08",
				profileData
			);
			...
			buyGem(
				message,
				"Topaz <:topaz:844645993747185686>",
				75,
				"09",
				profileData
			);
			...
			buyGem(
				message,
				"Moonstone <:moonstone:844646676337131521>",
				100,
				"10",
				profileData
			);
			...
			buyGem(
				message,
				"Quartz <:quartz:844740992473104384>",
				50,
				"12",
				profileData
			);
			...
			buyGem(
				message,
				"Alexandrite <:alexandrite:845793544278638603>",
				100,
				"13",
				profileData
			);
