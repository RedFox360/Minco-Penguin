	...
	if (current === 1) {
		...
		return {
			...
			content: `${start.toLocaleString(
				locale
			)} reached 1 at digit **${count.toLocaleString(
				locale
			)}**`,
			color: '#48c9b0'
		};
...
export const tau = new MessageEmbed()
	.setColor('#76d7c4')
	.setTitle('Tau τ')
	.setDescription(
...
export const phi = new MessageEmbed()
	.setColor('#f7dc6f')
	.setTitle('Phi Φ')
	.setDescription(
...
export const root2 = new MessageEmbed()
	.setColor('#d35400')
