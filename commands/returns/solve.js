...
export var name = "solve";
export var description = "Solve a math problem\nOperations: +, -, *, /, ^, sqrt, cbrt";
export var aliases = ["s"];
export var usage = "!solve <Math Equation>";
export function execute(message, args, cmd, client, profileData) {
    ...
    var equation = simplify(args.join(" ")).toString().split(" ");
...
function calculate(num1_s, num2_s, oper) {
    ...
    if (!num2)
        ...
        return parseInt(simplify(num1 + " " + oper + " " + num2).toString());
}
