...
export const name = "lie-detector";
export const aliases = ["lied", "ld"];
export const description = "Credit to Aiden for the idea : sends a is lying/not lying message";
export const usage = "!ld <Question>";
